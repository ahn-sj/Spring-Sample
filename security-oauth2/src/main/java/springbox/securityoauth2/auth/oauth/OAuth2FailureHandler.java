...
import springbox.securityoauth2.utils.CookieUtil;
...
import static springbox.securityoauth2.auth.oauth.CustomAuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;

@RequiredArgsConstructor
@Component
@Slf4j
public class OAuth2FailureHandler extends SimpleUrlAuthenticationFailureHandler {
    private final CustomAuthorizationRequestRepository cookieAuthorizationRequestRepository;
